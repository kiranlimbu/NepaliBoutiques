        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_RolePermissions_RoleId_PermissionId", x => new { x.RoleId, x.PermissionId }); // Unique constraint on composite keys
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstagramLink = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boutiques_Users_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_RoleUser_RolesId_UsersId", x => new { x.RolesId, x.UsersId }); // Unique constraint on composite keys
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItems_Boutiques_BoutiqueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SocialPosts_Boutiques_BoutiqueId",
                        column: x => x.BoutiqueId,
                        principalTable: "Boutiques",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "Name" },
                values: new object[] { 10, "View Users" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 10, 2 });

            migrationBuilder.CreateIndex(
                name: "IX_Boutiques_Category",
                table: "Boutiques",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_Boutiques_Location",
                table: "Boutiques",
                column: "Location");

            migrationBuilder.CreateIndex(
                name: "IX_Boutiques_Name",
                table: "Boutiques",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Boutiques_OwnerId",
                table: "Boutiques",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_BoutiqueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialPosts_BoutiqueId",
                table: "SocialPosts",
                column: "BoutiqueId");
