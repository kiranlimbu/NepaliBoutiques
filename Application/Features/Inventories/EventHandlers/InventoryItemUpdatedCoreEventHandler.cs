...
public sealed class InventoryItemUpdatedCoreEventHandler : INotificationHandler<InventoryItemUpdatedCoreEvent>
{
    private readonly ILogger<InventoryItemUpdatedCoreEventHandler> _logger;
    private readonly IBoutiqueRepository _boutiqueRepository;
    private readonly IUserRepository _userRepository;
    private readonly IEmailService _emailService;

    public InventoryItemUpdatedCoreEventHandler(
        ILogger<InventoryItemUpdatedCoreEventHandler> logger,
    ...
    /// <summary>
    /// Handles the InventoryItemUpdatedCoreEvent by sending an email notification to the boutique owner.
    /// </summary>
    /// <param name="notification">The event notification containing the inventory item details.</param>
    /// <param name="cancellationToken">Token to monitor for cancellation requests.</param>
    public async Task Handle(InventoryItemUpdatedCoreEvent notification, CancellationToken cancellationToken)
    {
        ...
        await _emailService.SendEmailAsync(user.Email, "Inventory Item Updated", $"Your inventory item {notification.Item.Caption} has been successfully updated");
    }
}
